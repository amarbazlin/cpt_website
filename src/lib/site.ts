...
export const products: Product[] = [
  ...
  },
  {
    ...
    brand: "ZRM",
    category: "motors-pumps",
    image: "/products/zrm/CPM180.png",
    price: 48400,
    summary: '1" water pump, 2HP for borehole, irrigation and general water transfer.',
    description:
      'The ZRM CPM180 is a 2HP water pump with a 1" outlet, suited to borehole lifting, irrigation and general water transfer. Supplied by Ceylon Platinum Trading (PVT) Ltd, Matara, for counter collection or island-wide delivery.',
    specs: [
      { label: "Model", value: "CPM180" },
      { label: "Type", value: "Water pump" },
      { label: "Outlet size", value: '1"' },
      { label: "Power", value: "2 HP" },
      { label: "Warranty", value: "5 years" },
    ],
  },
  {
    slug: "zrm-trailer-pump-3-ns80",
    name: 'ZRM Trailer Pump 3" NS80',
    brand: "ZRM",
    category: "motors-pumps",
    image: "/products/zrm/NS80.png",
    price: 54175,
    summary: '3" trailer pump for high-volume water transfer and drainage work.',
    description:
      'The ZRM NS80 is a 3" trailer pump built for high-volume water transfer, flood drainage and site dewatering. Supplied by Ceylon Platinum Trading (PVT) Ltd, Matara, for counter collection or island-wide delivery.',
    specs: [
      { label: "Model", value: "NS80" },
      { label: "Type", value: "Trailer pump" },
      { label: "Outlet size", value: '3"' },
      { label: "Warranty", value: "6 months" },
    ],
  },
  {
    slug: "zrm-vortex-pump-1-1hp-pm80",
    name: "ZRM Vortex Pump 1.1HP PM80",
    brand: "ZRM",
    category: "motors-pumps",
    image: "/products/zrm/PM80.png",
    price: 54450,
    summary: "1.1HP vortex pump for clean water transfer and pressure boosting.",
    description:
      "The ZRM PM80 is a 1.1HP vortex pump for moving clean water and boosting pressure in household and light agricultural applications. Supplied by Ceylon Platinum Trading (PVT) Ltd, Matara, for counter collection or island-wide delivery.",
    specs: [
      { label: "Model", value: "PM80" },
      { label: "Type", value: "Vortex pump" },
      { label: "Power", value: "1.1 HP" },
    ],
  },
  {
    slug: "zrm-submersible-pump-1hp-qdx750hf",
    name: "ZRM Submersible Pump 1HP QDX750HF",
    brand: "ZRM",
    category: "motors-pumps",
    image: "/products/zrm/QDX750HF.png",
    price: 41250,
    summary: "1HP submersible pump for boreholes, tanks and clean water supply.",
    description:
      "The ZRM QDX750HF is a 1HP submersible pump ideal for boreholes, water tanks, garden supply and clean water lifting. Supplied by Ceylon Platinum Trading (PVT) Ltd, Matara, for counter collection or island-wide delivery.",
    specs: [
      { label: "Model", value: "QDX750HF" },
      { label: "Type", value: "Submersible pump" },
      { label: "Power", value: "1 HP" },
      { label: "Warranty", value: "6 months" },
    ],
  },
  {
    slug: "zrm-cutter-pump-2hp-v1500df",
    name: "ZRM Cutter Pump 2HP V1500DF",
    brand: "ZRM",
    category: "motors-pumps",
    image: "/products/zrm/V1500DF.png",
    price: 65450,
    summary: "2HP cutter pump for surface drainage and high-flow water handling.",
    description:
      "The ZRM V1500DF is a 2HP cutter pump designed for surface water drainage and high-flow transfer. Supplied by Ceylon Platinum Trading (PVT) Ltd, Matara, for counter collection or island-wide delivery.",
    specs: [
      { label: "Model", value: "V1500DF" },
      { label: "Type", value: "Cutter pump" },
      { label: "Power", value: "2 HP" },
    ],
  },
  {
    slug: "zrm-trailer-pump-2-7-5hp-ns50",
    name: 'ZRM Trailer Pump 2" 7.5HP NS50',
    brand: "ZRM",
    category: "motors-pumps",
    image: "/products/zrm/NS50.png",
    price: 37950,
    summary: '2" trailer pump, 7.5HP for heavy-duty water transfer and drainage.',
    description:
      'The ZRM NS50 is a 2" trailer pump driven by a 7.5HP engine for heavy-duty water transfer and drainage work. Supplied by Ceylon Platinum Trading (PVT) Ltd, Matara, for counter collection or island-wide delivery.',
    specs: [
      { label: "Model", value: "NS50" },
      { label: "Type", value: "Trailer pump" },
      { label: "Outlet size", value: '2"' },
  ...
  {
    slug: "zrm-pressure-unit-epc01",
    name: "ZRM Pressure Unit EPC01",
    brand: "ZRM",
    category: "motors-pumps",
    image: "/products/zrm/EPC01.png",
    price: 10340,
    summary: "Compact pressure unit for automatic water pressure boosting.",
    description:
      "The ZRM EPC01 is a compact pressure unit that automatically maintains water pressure for households and small installations. Supplied by Ceylon Platinum Trading (PVT) Ltd, Matara, for counter collection or island-wide delivery.",
    specs: [
      { label: "Model", value: "EPC01" },
      { label: "Type", value: "Pressure unit" },
      { label: "Warranty", value: "6 months" },
    ],
  },
  {
    slug: "zrm-submersible-pump-0-75hp-qdx3-20-0-ssdf",
    name: "ZRM Submersible Pump 0.75HP QDX3-20-0-SSDF",
    brand: "ZRM",
    category: "motors-pumps",
    image: "/products/zrm/QDX3-20-0-SSDF.png",
    price: 29480,
    summary: "0.75HP submersible pump for tanks, boreholes and clean water lifting.",
    description:
      "The ZRM QDX3-20-0-SSDF is a 0.75HP submersible pump for water tanks, shallow boreholes and general clean water supply. Supplied by Ceylon Platinum Trading (PVT) Ltd, Matara, for counter collection or island-wide delivery.",
    specs: [
      { label: "Model", value: "QDX3-20-0-SSDF" },
      { label: "Type", value: "Submersible pump" },
  ...
  {
    slug: "zrm-water-pump-1hp-cpm158",
    name: "ZRM Water Pump 1HP CPM158",
    brand: "ZRM",
    category: "motors-pumps",
    image: "/products/zrm/CPM158.png",
    price: 36080,
    summary: "1HP water pump with big impeller for higher-rate water transfer.",
    description:
      "The ZRM CPM158 is a 1HP water pump with a big impeller for faster water transfer and irrigation duties. Supplied by Ceylon Platinum Trading (PVT) Ltd, Matara, for counter collection or island-wide delivery.",
    specs: [
      { label: "Model", value: "CPM158" },
      { label: "Type", value: "Water pump" },
      { label: "Power", value: "1 HP" },
      { label: "Design", value: "Big impeller" },
      { label: "Warranty", value: "6 months" },
    ],
  },
  {
    slug: "zrm-water-pump-0-75hp-cpm146",
    name: "ZRM Water Pump 0.75HP CPM146",
    brand: "ZRM",
    category: "motors-pumps",
    image: "/products/zrm/CPM146.png",
    price: 32450,
    summary: "0.75HP water pump for irrigation and household water supply.",
    description:
      "The ZRM CPM146 is a 0.75HP water pump suited to irrigation and household water supply duties. Supplied by Ceylon Platinum Trading (PVT) Ltd, Matara, for counter collection or island-wide delivery.",
    specs: [
      { label: "Model", value: "CPM146" },
      { label: "Type", value: "Water pump" },
      { label: "Power", value: "0.75 HP" },
      { label: "Warranty", value: "6 months" },
    ],
  ...
  {
    slug: "zrm-water-pump-0-5hp-cpm130",
    name: "ZRM Water Pump 0.5HP CPM130",
    brand: "ZRM",
    category: "motors-pumps",
    image: "/products/zrm/CPM130.png",
    price: 25520,
    summary: "0.5HP water pump with big impeller for compact water duties.",
    description:
      "The ZRM CPM130 is a 0.5HP water pump with a big impeller for compact irrigation and transfer duties. Supplied by Ceylon Platinum Trading (PVT) Ltd, Matara, for counter collection or island-wide delivery.",
    specs: [
      { label: "Model", value: "CPM130" },
      { label: "Type", value: "Water pump" },
  ...
  {
    slug: "zrm-water-pump-1hp-qb80",
    name: "ZRM Water Pump 1HP QB80",
    brand: "ZRM",
    category: "motors-pumps",
    image: "/products/zrm/QB80.png",
    price: 26125,
    summary: "1HP water pump for general transfer and clean water supply.",
    description:
      "The ZRM QB80 is a 1HP water pump for general water transfer and clean water supply. Supplied by Ceylon Platinum Trading (PVT) Ltd, Matara, for counter collection or island-wide delivery.",
    specs: [
      { label: "Model", value: "QB80" },
      { label: "Type", value: "Water pump" },
      { label: "Power", value: "1 HP" },
      { label: "Warranty", value: "6 months" },
    ],
  ...
  {
    slug: "zrm-deepwell-pump-0-33hp-3spm208",
    name: "ZRM Deepwell Pump 0.33HP 3SPM208",
    brand: "ZRM",
    category: "motors-pumps",
    image: "/products/zrm/3SPM208.png",
    price: 38500,
    summary: "0.33HP deepwell pump for lifting water from deep boreholes.",
    description:
      "The ZRM 3SPM208 is a 0.33HP deepwell pump for lifting water from deep boreholes and wells. Supplied by Ceylon Platinum Trading (PVT) Ltd, Matara, for counter collection or island-wide delivery.",
    specs: [
      { label: "Model", value: "3SPM208" },
      { label: "Type", value: "Deepwell pump" },
      { label: "Power", value: "0.33 HP" },
      { label: "Warranty", value: "6 months" },
    ],
  },
  {
    slug: "zrm-garden-pond-pump-0-5hp-qdxn350",
    name: "ZRM Garden Pond Pump 0.5HP QDXN350",
    brand: "ZRM",
    category: "motors-pumps",
    image: "/products/zrm/QDXN350.png",
    price: 15840,
    summary: "0.5HP garden and pond pump for fountains, ponds and watering.",
    description:
      "The ZRM QDXN350 is a 0.5HP garden and pond pump for fountains, pond circulation and garden watering. Supplied by Ceylon Platinum Trading (PVT) Ltd, Matara, for counter collection or island-wide delivery.",
    specs: [
      { label: "Model", value: "QDXN350" },
      { label: "Type", value: "Garden / pond pump" },
      { label: "Power", value: "0.5 HP" },
      { label: "Warranty", value: "6 months" },
    ],
  },
  {
    slug: "zrm-water-pump-0-5hp-qb60",
    name: "ZRM Water Pump 0.5HP QB60",
    brand: "ZRM",
    category: "motors-pumps",
    image: "/products/zrm/QB60.png",
    price: 17050,
    summary: "0.5HP water pump for light transfer and clean water supply.",
    description:
      "The ZRM QB60 is a 0.5HP water pump for light water transfer and clean water supply duties. Supplied by Ceylon Platinum Trading (PVT) Ltd, Matara, for counter collection or island-wide delivery.",
    specs: [
      { label: "Model", value: "QB60" },
      { label: "Type", value: "Water pump" },
      { label: "Power", value: "0.5 HP" },
      { label: "Warranty", value: "6 months" },
    ],
  ...
  {
    slug: "zrm-submersible-pump-2hp-wqd1500a",
    name: "ZRM Submersible Pump 2HP WQD1500A",
    brand: "ZRM",
    category: "motors-pumps",
    image: "/products/zrm/WQD1500A.png",
    price: 48950,
    summary: "2HP submersible pump for high-capacity water lifting.",
    description:
      "The ZRM WQD1500A is a 2HP submersible pump for high-capacity water lifting from wells, boreholes and tanks. Supplied by Ceylon Platinum Trading (PVT) Ltd, Matara, for counter collection or island-wide delivery.",
    specs: [
      { label: "Model", value: "WQD1500A" },
      { label: "Type", value: "Submersible pump" },
      { label: "Power", value: "2 HP" },
      { label: "Warranty", value: "6 months" },
    ],
  ...
  {
    slug: "zrm-submersible-pump-1hp-wqd750a",
    name: "ZRM Submersible Pump 1HP WQD750A",
    brand: "ZRM",
    category: "motors-pumps",
    image: "/products/zrm/WQD750A.png",
    price: 36080,
    summary: "1HP submersible pump for boreholes, tanks and water supply.",
    description:
      "The ZRM WQD750A is a 1HP submersible pump for boreholes, water tanks and clean water lifting. Supplied by Ceylon Platinum Trading (PVT) Ltd, Matara, for counter collection or island-wide delivery.",
    specs: [
      { label: "Model", value: "WQD750A" },
      { label: "Type", value: "Submersible pump" },
      { label: "Power", value: "1 HP" },
      { label: "Warranty", value: "6 months" },
    ],
